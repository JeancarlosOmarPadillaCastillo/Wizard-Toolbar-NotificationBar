...
@Named(value = "VentaC1")
@SessionScoped
public class VentaC1 implements Serializable {  
...
//    }
    ...
    public void manuel() {
        ...
        System.out.println("cantidad " + mot.getCANMOT());
        precio = mot.getPREVENMOT();
        CodigoProdu = mot.getIDMOT();
        subtotal = cantidad * precio;

        vendet = new VentaDetalle();
        vendet.setPreciopol(mot.getPREVENMOT());
